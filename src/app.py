...
DEFAULT_ACTIVITIES = {
    ...
    "Basketball Team": {
        "description": "Learn basketball fundamentals and compete in school leagues",
...
@app.get("/activities")
def get_activities_list(db: dict = Depends(get_activities_db)):
...
def unregister_from_activity(activity_name: str, email: str, db: dict = Depends(get_activities_db)):
